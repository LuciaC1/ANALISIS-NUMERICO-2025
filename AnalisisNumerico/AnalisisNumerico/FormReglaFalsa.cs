    ...
    public partial class FormReglaFalsa : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Respuesta result = MetodoReglaFalsa(num1, calculo, num2, tolerancia, interacciones);
        ...
        private static Respuesta MetodoReglaFalsa(double xi, Calculo funcion, double xd, double tolerancia, int interacciones)
        {
            ...
            for (int i = 0; i < interacciones; i++)
            {
                ...
                c = (funcion.EvaluaFx(xd) * xi - funcion.EvaluaFx(xi) * xd) / (funcion.EvaluaFx(xd) - funcion.EvaluaFx(xi));
